...
<?php
  $action = new action();
  $jobDetailslist = $action->jobDetailslist();
?>
<?php
  $page = $_GET['page'];
  if($page == "" || $page == "1" || $pagenumber<$page) {
    $page1 = "0";
  	$jobDetails = $action->jobDetails($page1);
  }else {
    $page1 = ($page*10)-10;
  	$jobDetails = $action->postDetails($page1);
  }
?>
<!doctype html>
            ...
            <div class="col-lg-8 left-box">
                ...
                <div class="card single-blog-post">
                    ...
                    <div class="body">
                        ...
                        <a href="job-details?id=<?php echo $res['id']; ?>" class="btn btn-raised btn-default">Read More</a>
                        <a href="job-delete?id=<?php echo $res['id']; ?>" class="btn btn-raised btn-default">Delete Post</a>
                    </div>
                </div>
              <?php } ?>
              <?php
                $jobtcount = $action->jobtcount();
                $pagenumber = ceil($jobtcount/10);
              ?>
                <ul class="pagination">
