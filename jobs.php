...
<?php
  ...
  if($page == "" || $page == "1" || $pagenumber<$page) {
    $page1 = "0";
    $jobsList = $action->jobsList($page1);
  }else {
    $page1 = ($page*10)-10;
    $jobsList = $action->jobsList($page1);
  }
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-12">
                            <div class="row">
                              <?php
                                while ($res = mysql_fetch_array($jobsList)) {
                              ?>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="pagination-btn-wrapper text-center--xs mb15--xs">
                                        <ul>
                                          ...
                                          <li class="active">
                                              <a href="jobs?page=<?php echo ($page-1);?>"><?php echo "<<"; ?></a>
                                          </li>
                                          <?php } ?>
                                          <?php for ($i=1; $i <= $pagenumber; $i++) { ?>
                                            <li class="active">
                                                <a href="jobs?page=<?php echo $i;?>"><?php echo $i;?></a>
                                            </li>
                                          <?php } ?>
                                          <li class="active">
                                              <a href="jobs?page=<?php echo ($page+1);?>"><?php echo ">>"; ?></a>
