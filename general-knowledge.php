...
<?php
  ...
  if($page == "" || $page == "1" || $pagenumber<$page) {
    $page1 = "0";
    $generalknowledgeList = $action->generalknowledgesList($page1);
  }else {
    $page1 = ($page*10)-10;
    $generalknowledgeList = $action->generalknowledgesList($page1);
  }
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-12">
                            ...
                            <div class="row mt-20-r mb-30">
                                <?php
                                  $generalknowledgecount = $action->generalknowledgecount();
                                  $pagenumber = ceil($generalknowledgecount/10);
                                ?>
                                <div class="col-sm-6 col-12">
                                    <div class="pagination-btn-wrapper text-center--xs mb15--xs">
                                        <ul>
                                          ...
                                          <li class="active">
                                              <a href="general-knowledge?page=<?php echo ($page-1);?>"><?php echo "<<"; ?></a>
                                          </li>
                                          <?php } ?>
                                          <?php for ($i=1; $i <= $pagenumber; $i++) { ?>
                                            <li class="active">
                                                <a href="general-knowledge?page=<?php echo $i;?>"><?php echo $i;?></a>
                                            </li>
                                          <?php } ?>
                                          <li class="active">
                                              <a href="general-knowledge?page=<?php echo ($page+1);?>"><?php echo ">>"; ?></a>
